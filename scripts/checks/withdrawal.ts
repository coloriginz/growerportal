...
check(
  ...
  resolveWithdrawalScope({ job: venster, supplierId: null, payloadRows: 4123 }).mode === "window"
);

const breed = resolveWithdrawalScope({ job: venster, supplierId: null, payloadRows: 4123 });
check(
...
check(
  ...
  resolveWithdrawalScope({ job: null, supplierId: null, payloadRows: 900 }).mode === "pairs",
...
check(
  ...
  resolveWithdrawalScope({ job: venster, supplierId: null, payloadRows: 0 }).mode === "pairs",
...
check(
  ...
  (() => {
    const r = resolveWithdrawalScope({ job: null, supplierId: null, payloadRows: 5 });
